        ...
        dialog.innerHTML = `
            ...
            <div style="margin-bottom: 20px;">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="number" id="shortFormMaxDuration" value="45" min="15" max="300" step="5"
                           style="width: 100%; padding: 10px; border: 1px solid #ecf0f1; border-radius: 6px;">
                    <small style="color: #7f8c8d; display: block; margin-top: 5px;">🎯 Target duration for expression clips and max duration for short-form batching (default: 45s)</small>
                </div>
                <div style="margin-bottom: 15px;">
